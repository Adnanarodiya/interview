...
export default function Home() {
  ...
  return (
    <>
      <Header />
      <section className="bg-hero-pattern h-[800px] bg-center bg-cover pb-52">
        <div className="pt-40">
          <h1 className="text-6xl w-[760PX] text-center justify-center mx-auto text-white">
      ...
      <section className="bg-white -mt-44 rounded-t-[100px]">
          ...
          <div className="container mt-14 ">
            <div className="p-8 flex pt-20">
              ...
              <p className="w-3/5 text-xl px-6">
                ...
                everyone at ultra-fast and affordable rates through the use of
                AI systems. Our mission is to establish a completely virtual
            ...
            <div>
              <div className="flex gap-16  mt-24">
                <div className="w-2/5 px-8">
                  ...
                  <p className="mt-2 w-[400px]">
                    ...
                    platform. Healthcare providers can also upload patient
              ...
              <div className="flex justify-end gap-16 mt-32 ">
                ...
                <div className="w-1/3 px-8 mr-20">
                  ...
                  <p className="mt-2 w-[400px]">
                    Mutanex utilizes advanced AI algorithms to analyze the
                    genetic data. This includes quality checks, sequence
                    testing, alignment, indexing, annotation, variant calling &
                    pathogenicity detection.
                  </p>
                </div>
                <div className="absolute end-44 w-20 -mt-32">
                  <img src="Vector 20.png" alt="" />
                </div>
              </div>
              <div className="flex justify-end gap-16 mt-32">
                <div className="absolute start-48 w-24 -mt-32">
                ...
                <div className="w-2/5 px-8 mr-20">
                  ...
                  <p className="mt-2 w-[430px]">
                    ...
                    your genes. The results are verified by a physician,
              ...
              <div className="flex justify-start gap-16 mt-32">
                ...
                <div className="w-2/5 px-8 mr-20">
                  ...
                  <p className="mt-2 w-[500px]">
                    We also facilitates dosage modification profiling by
                    tracking patient progress and adjusting treatments for
                    optimal outcomes through a user-friendly interface where
                    healthcare providers can input simple textual symptoms or
                    monitor progress over time.
                  </p>
                </div>
                <div className="absolute w-[100px] end-28  -mt-28">
        ...
        <section className="mt-20">
          <div className="container ">
            <div className="flex justify-start text-center items-center ml-36 mt-20 ">
              <h3 className="text-5xl">Transform your health</h3>
              <BsDot size={80} color="#3F3172" />
            </div>
            <div className="flex justify-start text-center items-center ml-[440px]   ">
              <BsDot size={80} color="#3F3172" />
              <h3 className="text-5xl ml-6">with expert advice from mutanex</h3>
            </div>
          </div>
        </section>
                    ...
                    <div className="flex mx-auto gap-8 w-4/5 mb-28">
                      <div>
                        ...
                        <p className="w-[450px] mt-4">
                          Mutanex uses advanced genetic sequencing technology
                          and artificial intelligence to identify potential
                          mutations in your genes, enabling early intervention
                          and prevention.
                        </p>
                        <button
                          type="button"
                  ...
                  <div className="mt-24">
                    <div className="flex mx-auto gap-8 w-4/5 mb-28">
                      <div>
                        ...
                        <p className="w-[450px] mt-4">
                          Mutanex has developed the world's first model for
                          predicting genetic mutations without genetic analysis,
                          using symptoms, demographics, and familial history
                          with a diagnosis-to-gene association AI model. Get a
                          Predicted analysis of your condition just by using
                          your clinical info with our Machine Learning Models
                          for Free.
                        </p>
                        <button
                          type="button"
                    ...
                    <div className="flex mx-auto gap-8 w-4/5 mb-28">
                      <div>
                        ...
                        <p className="w-[450px] mt-4">
                          ...
                          and artificial intelligence to identify potential
                          mutations in your genes, enabling early intervention
                          and prevention. Mutanex provides precision medicine
                          reports with ADR monitoring profiles and Drug
                          modification AI models.
                        </p>
                        <button
                          type="button"
                          className="p-3 mt-6 text-[#3F3172] border border-[#3F3172] rounded-full font-bold"
        ...
        <section className="bg-[url('/Gradient.png')] mt-20">
          <div className="container">
            <div className="flex justify-evenly py-20">
              <div>
                ...
                <p className="mt-6 w-[800px] text-2xl">
                  ...
                  sample report, a comprehensive 30-page document that delves
                  deep into your genetic makeup and provides you with a
                  personalized treatment profile.
                </p>
              </div>
        ...
        <section className="mt-28 bg-[#3F3073] text-white">
          <div className="container pt-20">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="">
                <input
                  className="bg-[#56439A] p-2 rounded-full w-96 mt-4 mr-4 pl-6"
                  type="email"
              ...
              <p className="mt-6 mb-20">
                Copyright 2024 Mutanex - All Rights Reserved
              </p>
            </div>
          </div>
        </section>
